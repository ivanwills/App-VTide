...
This documentation refers to App::VTide::Configuration version 0.0.1

=head1 SYNOPSIS

   use App::VTide::Configuration;
...
A list of environemnt variables to set for terminals. You use other environment
variables in the values (eg say setting the path you could use C<bin:$PATH>)
...
Tells how to split a tmux window into seperate panes
...
Details about each tmux terminal window
